...
const Navbar = () => {
  ...
  useEffect(() =>{
/* escucha cuando se esta scrolleando */
    const handleScroll = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 transition-all duration-400 ${isScrolled ? "glass-strong py-3" : "bg-transparent py-5"} right-0 z-50`}>
